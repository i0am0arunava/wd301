        ...
        <div className="w-full sm:w-1/2">
          <div className="bg-white border-black border rounded-md p-4">
            <h2 className="text-xl font-bold mb-4 flex flex-col items-center justify-center">Pending</h2>
              ...
              <TaskCard title="Build the website with static content" dueDate="10th April" completedAtDate=" " assigneeName="Rohit S" completed={false}/>
              <TaskCard title="Add a blog" dueDate="22nd March" completedAtDate=" " assigneeName="Rohit M" completed={false}/>
        ...
        <div className="w-full sm:w-1/2 ml-4">
          <div className="bg-white border-black border rounded-md p-4">
            <h2 className="text-xl font-bold mb-4 flex flex-col items-center justify-center">Done</h2>
              ...
              <TaskCard title="Design the mockup" dueDate=" " completedAtDate="10th April" assigneeName="Rohit M" completed={true} />
              <TaskCard title="Get the approval from the principal" dueDate=" " completedAtDate="20th April" assigneeName="Ajay S" completed={true} />
